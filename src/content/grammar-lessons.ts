...
**बनावट:** Subject + be + past participle`, ta: '', te: '', bn: '', mr: '', kn: '', ml: '', gu: '', pa: '', od: '', en: '' },
    ...
    exercises: [
      ...
      { id: 'b1-g2-ex13', type: 'multiple-choice', question: 'The streets _____ being cleaned when we arrived.', options: ['was', 'were', 'are', 'is'], correctAnswer: 'were', explanation: 'Past continuous passive: were being + past participle.', explanationTranslations: { hi: 'Past continuous passive: were being + past participle.', ta: '', te: '', bn: '', mr: '', kn: '', ml: '', gu: '', pa: '', od: '', en: '' } },
      { id: 'b1-g2-ex14', type: 'correct-error', question: 'Find the error: "Saffron is growed in Kashmir."', correctAnswer: 'Saffron is grown in Kashmir.', explanation: '"Grow" is irregular → past participle is "grown", not "growed".', explanationTranslations: { hi: '"Grow" अनियमित है → past participle "grown" है, "growed" नहीं।', ta: '', te: '', bn: '', mr: '', kn: '', ml: '', gu: '', pa: '', od: '', en: '' } },
    ],
  },
...
**अनियमित:** good → well, fast → fast`, ta: '', te: '', bn: '', mr: '', kn: '', ml: '', gu: '', pa: '', od: '', en: '' },
    ...
    exercises: [
      ...
      { id: 'a2-g5-ex14', type: 'correct-error', question: 'Find the error: "She cooks very good."', correctAnswer: 'She cooks very well.', explanation: '"Good" is an adjective. To describe HOW she cooks, use adverb "well".', explanationTranslations: { hi: '"Good" विशेषण है। कैसे खाना बनाती है → "well" (क्रिया विशेषण)।', ta: '', te: '', bn: '', mr: '', kn: '', ml: '', gu: '', pa: '', od: '', en: '' } },
    ],
  },
