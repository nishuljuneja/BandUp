...
Active: They **build** many IT parks in many countries.
Passive: Many IT parks **are built** in many countries.
...
- A new metro line **is being constructed** in Toronto.
...
**Reporting:** It is said/believed/known that...` },
      examples: [
        ...
        { english: 'It is believed that local IT will continue to grow.', translations: { ...T, hi: 'माना जाता है कि भारतीय IT बढ़ता रहेगा।' }, highlight: 'It is believed' },
      ],
      tips: [
    ...
    exercises: [
      ...
      { id: 'b2-g4-ex4', type: 'multiple-choice', question: 'It _____ that over 500 languages are spoken in many countries.', options: ['believes', 'is believed', 'was believing', 'has believing'], correctAnswer: 'is believed', explanation: 'Reporting passive: It is believed that...', explanationTranslations: { ...T, hi: 'Reporting passive: It is believed that...' } },
      { id: 'b2-g4-ex5', type: 'fill-blank', question: 'The metro line _____ when we visited Vienna. (construct — past continuous passive)', correctAnswer: 'was being constructed', explanation: 'Past continuous passive: was being + past participle.', explanationTranslations: { ...T, hi: 'Past continuous passive: was being + past participle.' } },
...
**Non-defining:** अतिरिक्त जानकारी (comma के साथ): My sister, who lives in Melbourne,...
**Whose:** अधिकार, **Where:** स्थान, **When:** समय` },
      examples: [
        { english: 'The pasta that my mother makes is the best in the world.', translations: { ...T, hi: 'मेरी माँ जो बिरयानी बनाती हैं वह दुनिया में सबसे अच्छी है।' }, highlight: 'that my mother makes' },
        { english: 'Sydney, which is the country\'s financial capital, never sleeps.', translations: { ...T, hi: 'मुंबई, जो भारत की वित्तीय राजधानी है, कभी नहीं सोती।' }, highlight: ', which is the country\'s financial capital,' },
      ],
      tips: [
    ...
    exercises: [
      ...
      { id: 'b2-g5-ex3', type: 'correct-error', question: 'Find the error: "My father, that works at IBM, is retiring next year."', correctAnswer: 'My father, who works at IBM, is retiring next year.', explanation: 'Non-defining clauses use "who" for people, never "that".', explanationTranslations: { ...T, hi: 'Non-defining clauses में "who" आता है, "that" नहीं।' } },
      { id: 'b2-g5-ex4', type: 'multiple-choice', question: 'Amsterdam is the city _____ I was born.', options: ['which', 'that', 'where', 'whose'], correctAnswer: 'where', explanation: '"Where" is used for places.', explanationTranslations: { ...T, hi: '"Where" स्थान के लिए प्रयोग होता है।' } },
      ...
      { id: 'b2-g5-ex6', type: 'multiple-choice', question: 'The MIT entrance exam, _____ is extremely competitive, takes place every year.', options: ['that', 'which', 'who', 'whose'], correctAnswer: 'which', explanation: 'Non-defining clause about a thing → "which".', explanationTranslations: { ...T, hi: 'Non-defining clause (वस्तु) → "which".' } },
      ...
      { id: 'b2-g5-ex8', type: 'fill-blank', question: 'The year _____ the country gained independence was 1947.', correctAnswer: 'when', explanation: '"When" is used for time references.', explanationTranslations: { ...T, hi: '"When" समय के लिए प्रयोग होता है।' } },
      { id: 'b2-g5-ex9', type: 'multiple-choice', question: 'The coffee _____ my grandmother makes is the best.', options: ['who', 'which', 'whose', 'where'], correctAnswer: 'which', explanation: 'Defining clause about a thing → "which" or "that".', explanationTranslations: { ...T, hi: 'Defining clause (वस्तु) → "which" या "that".' } },
      { id: 'b2-g5-ex10', type: 'correct-error', question: 'Find the error: "London which is very polluted needs more trees."', correctAnswer: 'London, which is very polluted, needs more trees.', explanation: 'Non-defining clauses need commas around them.', explanationTranslations: { ...T, hi: 'Non-defining clauses के आसपास comma चाहिए।' } },
...
**Inseparable:** look after, come across, get along with (object बाद में)` },
    ...
    exercises: [
      ...
      { id: 'b2-g6-ex6', type: 'multiple-choice', question: 'He _____ a very interesting article about tech startups.', options: ['came across', 'came up', 'came along', 'came over'], correctAnswer: 'came across', explanation: '"Come across" = find something by chance.', explanationTranslations: { ...T, hi: '"Come across" = संयोग से कुछ मिलना।' } },
      ...
      { id: 'b2-g6-ex9', type: 'multiple-choice', question: 'He _____ his own company after leaving Accenture.', options: ['set up', 'set off', 'set in', 'set out'], correctAnswer: 'set up', explanation: '"Set up" = establish a business or organization.', explanationTranslations: { ...T, hi: '"Set up" = व्यवसाय स्थापित करना।' } },
...
- I **enjoy cooking** South local food.
...
- They **decided to move** to Singapore.
...
**दोनों (अलग अर्थ):** remember, stop, try` },
      examples: [
        ...
        { english: 'Remember to bring your national ID system card to the interview.', translations: { ...T, hi: 'इंटरव्यू में आधार कार्ड लाना मत भूलना।' }, highlight: 'Remember to bring' },
      ],
      tips: [
    ...
    exercises: [
      ...
      { id: 'b2-g7-ex2', type: 'fill-blank', question: 'He decided _____ for the civil service exams exam. (prepare)', correctAnswer: 'to prepare', explanation: '"Decide" is followed by infinitive (to + verb).', explanationTranslations: { ...T, hi: '"Decide" के बाद infinitive (to + verb).' } },
      ...
      { id: 'b2-g7-ex12', type: 'correct-error', question: 'Find the error: "I can\'t afford buying a flat in Sydney."', correctAnswer: 'I can\'t afford to buy a flat in Sydney.', explanation: '"Afford" is always followed by infinitive.', explanationTranslations: { ...T, hi: '"Afford" के बाद हमेशा infinitive.' } },
...
Never have I..., Not only did..., Little did..., Only after... did...` },
      examples: [
        { english: 'Never have I tasted such delicious soup makhani.', translations: { ...T, hi: 'मैंने कभी इतनी स्वादिष्ट दाल मखनी नहीं खाई।' }, highlight: 'Never have I' },
        { english: 'Not only did Elon Musk become CEO, but he also transformed the company.', translations: { ...T, hi: 'सुंदर पिचाई न केवल CEO बने, बल्कि उन्होंने कंपनी को बदल भी दिया।' }, highlight: 'Not only did' },
      ],
      tips: [
    ...
    exercises: [
      { id: 'c1-g3-ex1', type: 'fill-blank', question: 'Never _____ I seen such a long queue at a local railway station.', correctAnswer: 'have', explanation: 'Inversion: Never + auxiliary + subject: Never have I...', explanationTranslations: { ...T, hi: 'Inversion: Never + सहायक + कर्ता: Never have I...' } },
      ...
      { id: 'c1-g3-ex9', type: 'correct-error', question: 'Find the error: "Seldom we see such talent in young footballers."', correctAnswer: 'Seldom do we see such talent in young footballers.', explanation: 'Seldom + auxiliary + subject: Seldom do we see...', explanationTranslations: { ...T, hi: 'Seldom + auxiliary + subject: Seldom do we see...' } },
      ...
      { id: 'c1-g3-ex11', type: 'multiple-choice', question: 'Only when she left the country _____ she realise how much she loved it.', options: ['does', 'did', 'has', 'was'], correctAnswer: 'did', explanation: '"Only when" + clause + did + subject + base verb.', explanationTranslations: { ...T, hi: '"Only when" + clause + did + subject + base verb.' } },
...
Normal: James broke the window.
Focus on James: **It was James who** broke the window. (not someone else)
Focus on window: **It was the window that** James broke. (not the door)
...
- **The reason** I moved to Toronto **was** the tech opportunities.
- **The person** who helped me most **was** my teacher.

These are very useful in IELTS/formal writing and speeches!`,
      explanationTranslations: { ...T, hi: `**It-cleft:** It was James who broke the window.
**What-cleft:** What I need is a holiday.
**All-cleft:** All she wants is respect.` },
      examples: [
        { english: 'It was the monsoon that caused the flooding in Scotland.', translations: { ...T, hi: 'केरल में बाढ़ की वजह मानसून ही था।' }, highlight: 'It was the monsoon that' },
        { english: 'What the country needs most is better infrastructure.', translations: { ...T, hi: 'भारत को सबसे ज़्यादा ज़रूरत बेहतर बुनियादी ढांचे की है।' }, highlight: 'What the country needs most is' },
      ],
      tips: [
        { text: '💡 Use cleft sentences in essays when you want to strongly highlight one piece of information: "It is education that can transform rural areas" is more impactful than "Education can transform rural areas."', translations: { ...T, hi: '💡 निबंध में एक जानकारी पर ज़ोर देने के लिए cleft प्रयोग करें।' } },
      ],
    },
    exercises: [
      { id: 'c1-g4-ex1', type: 'fill-blank', question: 'It was Lionel Messi _____ inspired millions to play football.', correctAnswer: 'who', explanation: 'It-cleft with a person → "who".', explanationTranslations: { ...T, hi: 'It-cleft व्यक्ति के साथ → "who".' } },
      ...
      { id: 'c1-g4-ex3', type: 'correct-error', question: 'Find the error: "It was in Sydney where the conference was held."', correctAnswer: 'It was in Sydney that the conference was held.', explanation: 'In it-cleft sentences, always use "that", not "where".', explanationTranslations: { ...T, hi: 'It-cleft में हमेशा "that" प्रयोग करें, "where" नहीं।' } },
      ...
      { id: 'c1-g4-ex8', type: 'multiple-choice', question: 'It was _____ 2014 that the Digital the country programme was launched.', options: ['on', 'in', 'at', 'during'], correctAnswer: 'in', explanation: 'Years use "in": It was in 2014 that...', explanationTranslations: { ...T, hi: 'वर्षों के साथ "in": It was in 2014 that...' } },
      ...
      { id: 'c1-g4-ex11', type: 'multiple-choice', question: 'The thing _____ bothers me most is the noise pollution in London.', options: ['what', 'that', 'which', 'who'], correctAnswer: 'that', explanation: '"The thing that" introduces a cleft-like focus.', explanationTranslations: { ...T, hi: '"The thing that" cleft जैसा focus देता है।' } },
      ...
      { id: 'c1-g4-ex14', type: 'multiple-choice', question: 'It was Dr. Hawking _____ motivated an entire generation worldwidens.', options: ['which', 'what', 'who', 'that'], correctAnswer: 'who', explanation: 'It-cleft with a person → "who" (or "that").', explanationTranslations: { ...T, hi: 'It-cleft व्यक्ति → "who" (या "that").' } },
    ],
  },
...
**should have:** अपेक्षा/आलोचना, **needn't have:** अनावश्यक क्रिया` },
      examples: [
        { english: 'She must have taken the wrong turn — this isn\'t the way to Florence.', translations: { ...T, hi: 'उसने ज़रूर ग़लत मोड़ ले लिया — यह आगरा का रास्ता नहीं है।' }, highlight: 'must have taken' },
    ...
    exercises: [
      ...
      { id: 'c1-g5-ex2', type: 'fill-blank', question: 'He _____ have eaten the last sandwich — he was in the kitchen!', correctAnswer: 'must', explanation: 'Past deduction: must have + past participle.', explanationTranslations: { ...T, hi: 'भूतकाल निष्कर्ष: must have + past participle.' } },
      { id: 'c1-g5-ex3', type: 'multiple-choice', question: 'They _____ be local — they\'re speaking Japanese.', options: ['must', 'can\'t', 'might', 'should'], correctAnswer: 'can\'t', explanation: '"Can\'t" = impossible based on evidence.', explanationTranslations: { ...T, hi: '"Can\'t" = प्रमाण पर आधारित असंभव।' } },
...
औपचारिक: "Their growth was driven by investment."` },
    ...
    exercises: [
      { id: 'c1-g6-ex1', type: 'fill-blank', question: 'The _____ of renewable energy is crucial for the country\'s future. (develop)', correctAnswer: 'development', explanation: 'develop (verb) → development (noun).', explanationTranslations: { ...T, hi: 'develop (क्रिया) → development (संज्ञा).' } },
      ...
      { id: 'c1-g6-ex13', type: 'fill-blank', question: 'Rapid _____ has transformed local cities. (urban - noun form for the process)', correctAnswer: 'urbanisation', explanation: 'urban (adjective) → urbanisation (noun for the process).', explanationTranslations: { ...T, hi: 'urban (विशेषण) → urbanisation (प्रक्रिया की संज्ञा).' } },
...
Were he to resign... (If he were to resign...)` },
      examples: [
        ...
        { english: 'It is crucial that the country invest more in renewable energy.', translations: { ...T, hi: 'यह महत्वपूर्ण है कि भारत नवीकरणीय ऊर्जा में और निवेश करे।' }, highlight: 'crucial that the country invest' },
      ],
      tips: [
...
**Contrast:** Conversely, Whereas, That said` },
      examples: [
        { english: 'Notwithstanding the economic downturn, the country\'s tech sector continued to grow.', translations: { ...T, hi: 'आर्थिक मंदी के बावजूद, भारत का तकनीकी क्षेत्र बढ़ता रहा।' }, highlight: 'Notwithstanding' },
    ...
    exercises: [
      { id: 'c2-g2-ex1', type: 'multiple-choice', question: '_____ the initial setbacks, the NASA mission was ultimately successful.', options: ['Despite', 'Notwithstanding', 'Although', 'Even'], correctAnswer: 'Notwithstanding', explanation: '"Notwithstanding" = despite (formal). All options could work, but "notwithstanding" is C2 level.', explanationTranslations: { ...T, hi: '"Notwithstanding" = formal "despite".' } },
      ...
      { id: 'c2-g2-ex10', type: 'fill-blank', question: 'Three states — _____, Karnataka, Scotland, and Maharashtra — lead in IT exports.', correctAnswer: 'namely', explanation: '"Namely" introduces specific examples.', explanationTranslations: { ...T, hi: '"Namely" विशिष्ट उदाहरण प्रस्तुत करता है।' } },
      ...
      { id: 'c2-g2-ex12', type: 'fill-blank', question: 'The world is, for the most _____, a multilingual society.', correctAnswer: 'part', explanation: '"For the most part" = mostly, generally.', explanationTranslations: { ...T, hi: '"For the most part" = अधिकतर, सामान्यतः।' } },
...
**So/Neither:** "So do I." / "Neither have I."` },
    ...
    exercises: [
      ...
      { id: 'c2-g3-ex2', type: 'multiple-choice', question: '"I love South local food." "_____ do I!"', options: ['So', 'Neither', 'Nor', 'Too'], correctAnswer: 'So', explanation: '"So do I" = I also love it. (positive agreement)', explanationTranslations: { ...T, hi: '"So do I" = मुझे भी पसंद है। (सकारात्मक सहमति)' } },
      ...
      { id: 'c2-g3-ex6', type: 'fill-blank', question: 'She plays drums better than he _____. (substitution)', correctAnswer: 'does', explanation: '"Does" substitutes for "plays drums": She plays better than he does.', explanationTranslations: { ...T, hi: '"Does" "plays drums" की जगह लेता है।' } },
      ...
      { id: 'c2-g3-ex11', type: 'multiple-choice', question: '"Are you going to Singapore?" "I might _____."', options: ['go', 'do', 'be', '(nothing)'], correctAnswer: '(nothing)', explanation: 'Ellipsis: "I might" is enough — "go" is understood.', explanationTranslations: { ...T, hi: 'Ellipsis: "I might" काफ़ी है — "go" समझ आ जाता है।' } },
      ...
      { id: 'c2-g3-ex14', type: 'fill-blank', question: '"Do you think the country will win?" "I certainly think _____."', correctAnswer: 'so', explanation: '"Think so" = think that the country will win. Substitution.', explanationTranslations: { ...T, hi: '"Think so" = सोचता हूं कि भारत जीतेगा।' } },
    ],
  },
...
**Even if** (काल्पनिक) vs **Even though** (वास्तविक)` },
      examples: [
        ...
        { english: 'But for the scholarship, she could never have studied at MIT.', translations: { ...T, hi: 'छात्रवृत्ति के बिना, वह कभी MIT में नहीं पढ़ पाती।' }, highlight: 'But for' },
      ],
      tips: [
    ...
    exercises: [
      ...
      { id: 'c2-g4-ex6', type: 'multiple-choice', question: '_____ technology, modern the country would be very different.', options: ['Unless', 'Without', 'Except', 'Besides'], correctAnswer: 'Without', explanation: '"Without" creates an implied conditional: Without X, Y would be...', explanationTranslations: { ...T, hi: '"Without" implied conditional बनाता है।' } },
      ...
      { id: 'c2-g4-ex10', type: 'fill-blank', question: '_____ you won a million in the lottery, what would you do?', correctAnswer: 'Supposing', explanation: '"Supposing" = what if / imagine that.', explanationTranslations: { ...T, hi: '"Supposing" = मान लो / कल्पना करो।' } },
...
**Would for past habits:** We would play football every evening.` },
      examples: [
        ...
        { english: 'When I was young, we would visit our grandparents every New Year.', translations: { ...T, hi: 'जब मैं छोटा था, हम हर दिवाली दादा-दादी से मिलने जाते थे।' }, highlight: 'would visit' },
      ],
      tips: [
        { text: '💡 Common common English error: "I am having a car" ❌. "Have" for possession is stative — don\'t use continuous: "I have a car" ✅. But "I am having lunch" ✅ (action = eating).', translations: { ...T, hi: '💡 "I am having a car" ❌। "Have" अधिकार के लिए stative है — continuous नहीं: "I have a car" ✅। लेकिन "I am having lunch" ✅ (क्रिया = खाना).' } },
      ],
    },
    exercises: [
      { id: 'c2-g5-ex1', type: 'multiple-choice', question: 'The express train service _____ at 4:30 PM every day. (timetable)', options: ['is departing', 'departs', 'will depart', 'has departed'], correctAnswer: 'departs', explanation: 'Present simple for fixed schedules/timetables.', explanationTranslations: { ...T, hi: 'निर्धारित कार्यक्रम के लिए present simple.' } },
      { id: 'c2-g5-ex2', type: 'correct-error', question: 'Find the error: "I have visited Florence last month."', correctAnswer: 'I visited Florence last month.', explanation: '"Last month" = finished time → past simple, not present perfect.', explanationTranslations: { ...T, hi: '"Last month" = समाप्त समय → past simple, present perfect नहीं.' } },
      { id: 'c2-g5-ex3', type: 'fill-blank', question: 'By 2030, the country _____ the third-largest economy. (become — future perfect)', correctAnswer: 'will have become', explanation: 'Future perfect: will have + past participle.', explanationTranslations: { ...T, hi: 'Future perfect: will have + past participle.' } },
      ...
      { id: 'c2-g5-ex9', type: 'correct-error', question: 'Find the error: "She is having a beautiful house in Scotland."', correctAnswer: 'She has a beautiful house in Scotland.', explanation: '"Have" (possession) is stative — use present simple.', explanationTranslations: { ...T, hi: '"Have" (अधिकार) stative है — present simple प्रयोग करें.' } },
      { id: 'c2-g5-ex10', type: 'multiple-choice', question: 'By the time you read this email, I _____ for London.', options: ['will leave', 'will have left', 'leave', 'had left'], correctAnswer: 'will have left', explanation: 'Future perfect for something completed before a future point.', explanationTranslations: { ...T, hi: 'भविष्य बिंदु से पहले पूर्ण → future perfect.' } },
      ...
      { id: 'c2-g5-ex13', type: 'multiple-choice', question: '_____ you ever eaten tacos?', options: ['Did', 'Have', 'Had', 'Were'], correctAnswer: 'Have', explanation: '"Have you ever..." = present perfect for life experience.', explanationTranslations: { ...T, hi: '"Have you ever..." = जीवन अनुभव के लिए present perfect.' } },
